...
#
default: help
MAKEFILETARGETS=x86_64-linux x86_64-freebsd x86_64-haiku x86_64-netbsd x86_64-solaris x86_64-openbsd x86_64-darwin x86_64-win64 x86_64-iphonesim x86_64-android x86_64-dragonfly aarch64-linux aarch64-freebsd aarch64-darwin aarch64-win64 aarch64-iphonesim aarch64-android aarch64-ios
BSDs = freebsd netbsd openbsd darwin dragonfly
UNIXs = linux $(BSDs) solaris qnx haiku
LIMIT83fs = atari human68k
FORCE:
.PHONY: FORCE
...
ifndef ALLTARGET
SHAREDTARGETS=
SMARTTARGETS=linux freebsd netbsd openbsd darwin
...
NOUTILSTARGETS=$(BuildOnlyBaseCPUs)
...
ifneq ($(filter $(FPCFPMAKE_CPU_TARGET),aarch64 x86_64),)
