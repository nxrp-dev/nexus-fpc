...
NOUTILSTARGETS=embedded gba nds macosclassic $(BuildOnlyBaseCPUs) freertos
...
ifneq ($(filter $(FPCFPMAKE_CPU_TARGET),aarch64 powerpc64 sparc64 x86_64),)
...
ifneq ($(filter $(CPU_TARGET),x86_64 mips mipsel mips64 mips64el powerpc64),)
override FPCOPT+=-Cg
endif
endif
ifdef LINKSHARED
